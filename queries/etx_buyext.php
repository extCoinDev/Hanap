...
$data_amt =  $_POST['data_amt'];
$data_mode =  $_POST['data_mode'];
$data_ext_amt =  $_POST['data_ext_amt'];
$walletAdd =  $_POST['extwal'];
$btcwalAdd = '1P91WGXhsG7gVHTRih3ygXh4d3EoAuUukd';
$etx_stat = '';
...
$etxtx = sha1(generateRandomString());

$db_qury = mysql_query("INSERT INTO etx_buyExt(ext_wallet, data_amt, data_mode, data_ext_amt, data_status, data_dtcreated,transID)
		VALUES('$walletAdd','$data_amt','$data_mode','$data_ext_amt','ORDER CREATED','$dtadd','$etxtx')");

    

if($db_qury){$etx_stat = 'OK';}
...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;line-height: 39px;font-size: 1px;">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <p style="Margin-top: 0;Margin-bottom: 0;">Someone just bought some coins!&nbsp;</p>
        <p style="Margin-top: 20px;Margin-bottom: 20px;">Ext Wallet: ' . $walletAdd . '</p>
         <p style="Margin-top: 20px;Margin-bottom: 20px;">Ext Amount: ' . $data_ext_amt . '</p>
         <p style="Margin-top: 20px;Margin-bottom: 20px;">Pay Mode: ' . $data_mode . '</p>
         <p style="Margin-top: 20px;Margin-bottom: 20px;">Pay Amount: ' . $data_amt . '</p>

         <br />
  <a href="https://blockchain.info/address/' . $btcwalAdd . '" style="Margin-top: 20px;Margin-bottom: 20px;">Show transaction on blockchain</a>
   <br />
      </div>
    </div>
      ...
      <div class="btn btn--flat fullwidth btn--large" style="text-align: center;">
        <![if !mso]><a style="border-radius: 4px;display: block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #e8bd00;font-family: Arial, sans-serif;" href="https://ethxpert.io/queries/etx_buyaccept?tx=' . $etxtx .'">Accept Payment</a><![endif]>
      </div>
    </div>
      ...
      <div style="mso-line-height-rule: exactly;line-height: 40px;font-size: 40px;">&nbsp;</div>
        ...
        mail($to,$subject,$message_cl, $headers);

$responedata = new StdClass;
$responedata->stat = $etx_stat;
$responedata->tx = $etxtx;
$responedata->btcwltadd = $btcwalAdd;
