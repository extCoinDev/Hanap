<div id="pages_transfer" class="page animated fadeInUp w3-col m8 l9" style="-webkit-animation-duration: .3s !important; z-index:1200">
    <div class="page_bkg" style="background-color: #FFA000">
        ...
        <div id="feed_body" class="feed_body" style="-webkit-animation-duration: .8s !important">
            ...
            <br />
            <p>AMOUNT TO SEND</p>
            <input id="" oninput="" class="w3-input w3-border w3-round w3-white" style="width: 50%; font-size: 18px; text-align: left; outline: none" type="number">
