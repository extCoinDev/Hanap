<div id="pages_interface4" class="page animated slideInRight" style="animation-duration:.5s!important; overflow: hidden; z-index: 500 !important;width: 100%; padding-top: 0px; height:100vh; animation-delay:.5s; background-color:white;">
    ...
    <div>
        <div class="w3-display-container" style="background-color:#FFCA28;width:100%;height:33%;border-bottom-right-radius:45%;border-bottom-left-radius:45%;">
        ...
        <!--Arrow-->
            ...
            <div class="w3-display-topleft w3-circle w3-border w3-border-white" style="font-size:22px;color:white;margin-left:15px;margin-right:auto;margin-top:15px;padding:5px">
                <i class="fa fa-arrow-left"></i>
            </div>



        <div class="w3-display-topright" style="padding-top:20px;padding-right:20px">
            <p style="color:white; font-size: 16px; text-align: right; ">Edit</p>
        </div>
        ...
        <div>
            <h1 style="color:black; display: block; margin-left: 26%; margin-right: auto;margin-top:4% ">Sora Shiro</h1>
            
            <p style="color: #757575; display: block; margin-left: auto; margin-right: 0%; margin-top: 2%; font-size: 12px; text-align: center; ">Manila, Philippines</p>
        </div>
        ...
        <div class="w3-display-bottommiddle w3-display-container" style="background-color:#FFCA28;width:100%;height:5%">
