<div id="pages_interface2" class="page animated slideInRight" style="animation-duration:.5s!important; overflow: hidden; z-index: 500 !important;width: 100%; padding-top: 0px; height:100vh; animation-delay:.5s; background-color:white;">
  ...
  <div class="w3-display-container" style="background-color:#FFCA28;width:100%;height:20%;">
