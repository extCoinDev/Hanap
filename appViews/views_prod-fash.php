<div id="pages_prod-fash" class="page animated slideInRight" style="animation-duration:.5s!important; overflow: hidden; z-index: 500 !important;width: 100%; padding-top: 0px; height:100vh; animation-delay:.5s">
    ...
    <div class="w3-card-4" style="background-color: #FFCA28; height: 10%; width:100%;margin-top:-20px;text-align:center;padding-top:5px;color:white;">
        ...
        <div class="" style="font-family:Arial">
            ...
            <h4 class="" style="margin-top:-12px"><b>FASHION</b></h4>
        </div>
    </div>
