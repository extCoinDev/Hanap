<div id="pages_buyext_btc" class="page animated slideInRight w3-col m8 l9" style="-webkit-animation-duration: .3s !important;">
    <div class="page_bkg" style="background-color: #FFA000">
        <div class="page_menu" style="background-color: #FFA000">
            <h5 style="margin-left:auto; position: absolute; margin-right:auto; text-align:center; display:inline-block; width:100%; font-size:20px; font-weight:600; margin-top:3px;">Buy with Bitcoin</h5>

            <div style="  position:absolute ; width:100%; left:0; padding-right:15px;padding-left:15px; padding-left:15px">
                <i class="fa fa-chevron-left" onclick="close_view('pages_buyext_btc','YES');" style="color: white; font-size: 24px"></i>
            ...
            <div class="">
                ...
                <option value="XMR">Monero</option>
                            ...
                            <div class="w3-col m8 s8 l8  w3-right">
                                <input id="extequi_buy" oninput="computeBuyExt('BTC', 'BTC');" class="w3-input w3-border-0 w3-white wow fadeIn" style="width:100%; margin-left:auto; margin-right:auto; font-size:24px; text-align:right; outline:none;" value="0" type="number">
                        ...
                        <div style="height:50px">
                            <div class="w3-col m3 s3 l3">
                                <select class="w3-select w3-white" style="border-bottom: solid 1px #FFA000; ">
                            ...
                            <div class="w3-col m8 s8 l8  w3-right">
                                <input id="extwbuy_input" oninput="computeBuyExt('EXT', 'BTC');" class="w3-input w3-border-0 w3-white wow fadeIn" style="width:100%; margin-left:auto; margin-right:auto; font-size:24px; text-align:right; outline:none" value="0" type="number">
                            ...
                            <div class="w3-col s12 m12 l12 w3-center">
                                ...
                                <br />
                                <button class="w3-button w3-round w3-padding-16 w3-ripple" onclick="payments_finalizePay('BTC');;" style="width: 40%; margin-bottom: 25px; background-color: #FFA000; color: white">NEXT</button>
                            </div>
