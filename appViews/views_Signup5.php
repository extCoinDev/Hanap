<div id="pages_EnterName5" class="page animated slideInRight" style="animation-duration: .5s!important;
    ...
    <div class="dex2" style="margin-left:30px;margin-right:auto;display:block;text-align:Left;margin-top:40px;padding-bottom:20px;">
...
<div class="">
<input class="w3-radio" type="radio" name="gender" value="Tech">
<label>Household Products</label>
</div>

<div class="">
<input class="w3-radio" type="radio" name="gender" value="Home Service" >
<label>Tech Products</label>
</div>
