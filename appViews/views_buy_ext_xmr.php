<div id="pages_buyext_xmr" class="page animated slideInRight w3-col m8 l9" style="-webkit-animation-duration: .3s !important;">
    <div class="page_bkg" style="background-color: #FFA000">
        <div class="page_menu" style="background-color: rgb(255, 103, 1)">
            <h5 style="margin-left:auto; position: absolute; margin-right:auto; text-align:center; display:inline-block; width:100%; font-size:20px; font-weight:600; margin-top:3px;">Buy with Monero</h5>

            <div style="  position:absolute ; width:100%; left:0; padding-right:15px;padding-left:15px; padding-left:15px">
                <i class="fa fa-chevron-left" onclick="close_view('pages_buyext_xmr', 'YES');" style="color: white; font-size: 24px"></i>
                    ...
                    <div id="buy_ext_btc_initForm" class="animated slideInRight" style="-webkit-animation-duration: .5s; position: absolute; left: 20px; right: 20px; ">
                        ...
                        <div style="height:50px">
                            ...
                            <option value="XMR">Monero</option>
                                ...
                                <h3 style=" margin-left: 5px; margin-top: 13px;">XMR</h3>
                            </div>

                            <!-- <h1 id="extequi_buy" class="animated fadeIn" style="margin:0px">0.00</h1>-->
                            <div class="w3-col m8 s8 l8  w3-right">
                                <input id="extequi_xmr_buy" oninput="computeBuyExt('XMR', 'XMR');" class="w3-input w3-border-0 w3-white wow fadeIn" style="width:100%; margin-left:auto; margin-right:auto; font-size:24px; text-align:right; outline:none;" value="0" type="number">
                                <h6 id="buy_ext_btc_price" class="w3-right" style="margin-top: 0x; color: #777;">Monero </h6>
                            </div>
                        ...
                        <div style="height:50px">
                            ...
                            <div class="w3-col m8 s8 l8  w3-right">
                                <input id="extwbuy_xmr_input" oninput="computeBuyExt('EXT', 'XMR');" class="w3-input w3-border-0 w3-white wow fadeIn" style="width:100%; margin-left:auto; margin-right:auto; font-size:24px; text-align:right; outline:none" value="0" type="number">
                            ...
                            <div class="w3-col s12 m12 l12 w3-center">
                                ...
                                <br />
                                <button class="w3-button w3-round w3-padding-16 w3-ripple" onclick="payments_btc_finalizePay();" style="width: 40%; margin-bottom: 25px; background-color: rgb(255, 103, 1); color: white">NEXT</button>
                            </div>
