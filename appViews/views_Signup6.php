<div id="pages_EnterName6" class="page animated slideInRight" style="animation-duration: .5s!important;
   ...
   <input class="w3-input" placeholder="Email Address"  type="text" style="margin-top:30px;text-align:left; width:90%;margin-left:auto;margin-right:auto;font-size:20px;padding:30px;">

   <input class="w3-input" placeholder="Phone Number"  type="text" style="margin-top:10px;text-align:left; width:90%;margin-left:auto;margin-right:auto;font-size:20px;padding:30px;">
